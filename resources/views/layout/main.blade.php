...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{asset('storage/image/logotab.png')}}"> 
    <link href="{{asset('storage/image/logotab.png')}}" rel="stylesheet">
    ...
    <a class="navbar-brand" href="{{ url('/') }}">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link text-right" href="{{ url('/aboutus') }}">About us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-right" href="{{ url('/product') }}">Product</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-right" href="{{ url('/howtobuy') }}">How to Buy</a>
              </li>
    ...
    <footer  style="background-color: #ffffff">
        <div class="container">
            ...
            <div class="text-center"> 
              <p class="text-dark py-4 mb-4 text-center" style="margin-bottom: 0px !important;">&copy;2020 Ekspresa</p>
            </div>
        </div>
     </footer>
     <!-- end of footer -->
